  ...
  return (
    <div className='w-100' dir="rtl">
      <div className='pb-10 pb-lg-15'>
        <h2 className='fw-bolder text-gray-900'>اطلاعات حساب</h2>
      ...
      <div className='mb-10 fv-row'>
        <label className='d-flex align-items-center form-label mb-3'>
          اندازه تیم را مشخص کنید
          <i
            className='fas fa-exclamation-circle ms-2 fs-7'
            data-bs-toggle='tooltip'
            title='اندازه تیم خود را برای کمک به تنظیم صورتحساب ارائه دهید'
          ></i>
        </label>
      ...
      <div className='mb-10 fv-row'>
        <label className='form-label mb-3'>نام حساب تیم</label>
      ...
      <div className='mb-0 fv-row'>
        <label className='d-flex align-items-center form-label mb-5'>
          ...
          <i
            className='fas fa-exclamation-circle ms-2 fs-7'
            data-bs-toggle='tooltip'
            title='صورتحساب ماهانه بر اساس طرح حساب شما خواهد بود'
          ></i>
        </label>
